...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("criteria_results", postgresql.JSONB(), nullable=False, server_default=sa.text("'{}'::jsonb")),
        sa.Column("rejection_reasons", postgresql.JSONB(), nullable=True, server_default=sa.text("'[]'::jsonb")),
